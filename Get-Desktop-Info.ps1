...
# https://community.spiceworks.com/scripts/show/2773-get-remote-computer-system-and-hardware-information
# https://community.spiceworks.com/scripts/show/2787-export-system-info-to-csv-via-logon-script

#>

$ArrComputers =  Get-ADComputer -Filter 'Name -like "SJO-DEV*"' | ForEach-Object {$_.Name}
