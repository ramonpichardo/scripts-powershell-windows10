...
choco install chocolatey-core.extension firefox googlechrome adobereader silverlight jre8 vlc git.install xmind winscp.install filezilla winpcap wireshark rvtools 7zip.install putty.install mRemoteNG terraform -y
