...
choco install chocolatey-core.extension firefox googlechrome adobereader vlc git.install xmind winscp.install winpcap wireshark rvtools 7zip.install putty.install mRemoteNG terraform -y
